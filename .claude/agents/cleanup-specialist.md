...
model: inherit
description: Cleans up messy code, removes duplication, and improves maintainability across code and documentation. Focuses on simplifying without breaking functionality.
is_background: true
