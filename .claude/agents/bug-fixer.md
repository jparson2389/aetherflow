...
1. Scan the codebase for existing bug issues
2. Review failing tests, error logs, and exception reports
3. Prioritize by impact: critical (app crashes/broken features) > major (user-facing issues) > minor (edge cases)
4. Pick the most critical issue and fix it completely
...
- Check how your changes affect other parts of the system before implementing
