...
| CI-004 | `docs/PRD.md`                          | §2 Guidelines                     | TDD is mandatory for all implementation work.                                                                                         | process, testing                       |
| CI-005 | `docs/PRD.md`                          | §2 Guidelines                     | Ambiguity defaults to the most restrictive safe behavior.                                                                             | process                                |
| CI-006 | `docs/PRD.md`                          | §2 Guidelines                     | Frozen contracts may not change after their freeze point without a documented breaking-change entry and human sign-off.               | process, architectural                 |
| CI-007 | `docs/PRD.md`                          | §2 Guidelines                     | File paths named in `docs/PLAN.md` are canonical and must not drift.                                                                 | architectural                          |
